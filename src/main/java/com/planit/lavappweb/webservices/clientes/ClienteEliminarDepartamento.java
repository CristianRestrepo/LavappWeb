 ...
 * [eliminarDepartamento]<br>
 * USAGE:
 * <pre>
 *        ClienteEliminarDepartamento client = new ClienteEliminarDepartamento();
 ...
 */
public class ClienteEliminarDepartamento {
    private WebTarget webTarget;
    private Client client;
    private static final String BASE_URI = "http://localhost:8084/LavappService/webresources/";

    public ClienteEliminarDepartamento() {
        client = ResteasyClientBuilder.newBuilder().build();
        webTarget = client.target(BASE_URI).path("eliminarDepartamento");
    }
     ...
     */
    public <T> T eliminarDepartamento(Class<T> responseType, String idDepartamento) throws ClientErrorException {
