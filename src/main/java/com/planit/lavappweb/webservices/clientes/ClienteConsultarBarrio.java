...
/**
 * Jersey REST client generated for REST resource:we [consultarBarrio]<br>
 * USAGE:
 * <pre>
 *        ClienteConsultarBarrio client = new ClienteConsultarBarrio();
 ...
 */
public class ClienteConsultarBarrio {
    private WebTarget webTarget;
    private Client client;
    private static final String BASE_URI = "http://localhost:8084/LavappService/webresources/";

    public ClienteConsultarBarrio() {
        client = ResteasyClientBuilder.newBuilder().build();
        webTarget = client.target(BASE_URI).path("consultarBarrio");
    }
