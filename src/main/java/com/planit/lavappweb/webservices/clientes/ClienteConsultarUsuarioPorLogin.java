...
public class ClienteConsultarUsuarioPorLogin {
     ...
     */
    public <T> T consultarUsuarioPorLogin(Class<T> responseType, String email) throws ClientErrorException {
        String[] queryParamNames = new String[]{"email"};
        String[] queryParamValues = new String[]{email};
        ;
