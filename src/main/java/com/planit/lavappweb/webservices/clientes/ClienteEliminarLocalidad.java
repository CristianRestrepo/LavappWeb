 ...
 * [eliminarLocalidad]<br>
 * USAGE:
 * <pre>
 *        ClienteEliminarLocalidad client = new ClienteEliminarLocalidad();
 ...
 */
public class ClienteEliminarLocalidad {
    private WebTarget webTarget;
    private Client client;
    private static final String BASE_URI = "http://localhost:8084/LavappService/webresources/";

    public ClienteEliminarLocalidad() {
        client = ResteasyClientBuilder.newBuilder().build();
        webTarget = client.target(BASE_URI).path("eliminarLocalidad");
    }
     ...
     */
    public <T> T eliminarLocalidad(Class<T> responseType, String idLocalidad) throws ClientErrorException {
